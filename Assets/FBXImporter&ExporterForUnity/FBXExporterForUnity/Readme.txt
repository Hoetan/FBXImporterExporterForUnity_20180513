...
FBX Exporter for Unity β Version 2018/05/13
...
■対応3Dエンジン
 ...
 Unity Personal/Professional v5.6.5f1 (64bit)
...
　FBXファイルは、3ds Max 2018 / Maya 2018 / Softimage 2015 / MotionBuilder 2018 / StingrayとFBX Importer for Unityに対応しています。
　Maya用にAnimatorの出力をする場合は、「Apply Root Motion」のチェックを外してから出力するようにしてください。
　使用されたテクスチャは、「Textures」フォルダに、PNG形式に自動変換され出力されます。
　DCCToolsが2018より下位のバージョンで、FBX形式(2018.1.1)を読み込む場合は、「FBX Converter 2013.3」を使用して、古いバージョンのＦＢＸ形式にコンバートしてから読み込んで下さい。
...
This FBX file is compatible with: 3ds Max 2018, Maya 2018, Softimage 2015, MotionBuilder 2018, Stingray and FBX Importer for Unity.
...
If the DCCTools being used is prior to the 2018 version; in order to be able to open the FBX format file (2018.1.1), please convert it to an older version of the FBX format using “FBX Converter 2013.3”.
